 ...
 */
export function isAIInsights(obj: unknown): obj is AIInsights {
  if (typeof obj !== 'object' || obj === null) {
    return false;
  }

  const insights = obj as Partial<AIInsights>;

  // Validation basique : au moins un champ AI présent
  return (
    insights.sentiment !== undefined ||
 ...
 */
export function isCartaeMetadata(obj: unknown): obj is CartaeMetadata {
