 ...
 */
export type RelationshipType = 'parent' | 'child' | 'related' | 'references' | 'blocks' | 'blockedBy' | 'duplicates' | 'duplicatedBy' | 'replaces' | 'replacedBy' | 'dependsOn' | 'requiredBy';
/**
 ...
 */
export declare function isCartaeRelationship(obj: unknown): obj is CartaeRelationship;
/**
 ...
 */
export declare function getInverseRelationType(type: RelationshipType): RelationshipType | null;
//# sourceMappingURL=CartaeRelationship.d.ts.map