...
export type EventSource =
  | 'core' // Core system
  | 'user' // Action utilisateur directe
  | 'plugin' // Plugin (data, viz, ai...)
  | 'storage' // Système de storage
...
// ============================================================================
// CartaeItem Events - CRUD operations
// ============================================================================
...
// ============================================================================
// Union Types - Type-safe event handling
// ============================================================================

/**
 * Tous les types d'événements CartaeItem
 */
export type CartaeItemEvent =
  | CartaeItemCreatedEvent
  | CartaeItemUpdatedEvent
  | CartaeItemDeletedEvent
  | CartaeItemsBulkCreatedEvent
  | CartaeItemsBulkDeletedEvent;
